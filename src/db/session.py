...
CONTEXTVAR = ContextVar[Any]("var", default=None)
...
class BaseSession(Generic[Session_T]):
    ...
    def set_session(self, session: Session_T | None):
    ...
    def get_session(self) -> Session_T | None:
        context_id = CONTEXTVAR.get()
        return self.sessions.get(context_id, None)

    def generate_session_scope_func(
        self,
...
#
# from src.main.db.connectors import CONTEXTVAR, SQLServerConnectorPool
