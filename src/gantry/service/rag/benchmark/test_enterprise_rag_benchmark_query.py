...
from gantry.service.rag.benchmark.test_enterprise_rag_benchmark_dataloader import (
    EnterpriseRagDatasetLoader,
)
...
SUMMARY_FILE = "enterprise_rag_benchmark_summary.json"

RAG_QUERY_TOP_K: int = 10
RAG_QUERY_HYBRID_SEARCH: bool = True
RAG_QUERY_HYBRID_SEARCH_BM25_TOP_K: int = 10
RAG_QUERY_HYBRID_SEARCH_SEMANTIC_TOP_K: int = 10
...
async def main(argv: list[str] | None = None) -> int:
    ...
    dataset_loader = EnterpriseRagDatasetLoader()
