...
from gantry.service.rag.benchmark.test_legal_rag_benchmark_dataloader import (
    LegalRagDatasetLoader,
)
...
SUMMARY_FILE = "legal_rag_benchmark_summary.json"
...
async def main(argv: list[str] | None = None) -> int:
    ...
    dataset_loader = LegalRagDatasetLoader()
