...
file_storage_internal_router = APIRouter(
    tags=["file-storage"], prefix="/file-storage"
)


@file_storage_internal_router.post(
    "/",
...
@file_storage_internal_router.get(
    "/",
...
@file_storage_internal_router.delete(
    "/{file_id}",
...
@file_storage_internal_router.put(
    "/{file_id}/metadata",
...
file_storage_router.include_router(file_storage_internal_router, prefix="/user")
