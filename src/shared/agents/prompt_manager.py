"""Prompt Manager for registering prompts async for agents."""
from src.service.chat.agents import CHAT_AGENT_PROMPT_ID
from src.shared.agents.tools.web import (
    WEB_SEARCH_TOOL_PROMPT_ID,
    VISIT_WEB_PAGE_TOOL_PROMPT_ID,
)
from src.service.ai_search.agents import AI_SEARCH_AGENT_PROMPT_ID
from src.service.rx_advisor.agents import RX_ADVISOR_AGENT_PROMPT_ID
from src.shared.agents.agent_manager import AgentManagerService
from src.service.ehr_summarize.agents import EHR_SUMMARY_AGENT_PROMPT_ID
from src.shared.agents.tools.open_fda import (
...
class PromptManager:
    """Manages the registration of prompts for agents."""
    def __init__(self, agent_manager: AgentManagerService):
        """Initialize PromptManager with AgentManagerService."""
        self.agent_manager = agent_manager

    async def registerPrompt(self):
        """Async register prompts."""
        # simulate prompt loading async from api, file or db
        # TODO implement actual loading logic from db or file here
        self.agent_manager.register_prompt(
